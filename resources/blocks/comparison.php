...
$link = get_field('Link');
$more_info = get_field('more_info_enabled');

?>


<div id="<?php echo $id; ?>" class="<?php echo $blockClass; ?> <?php echo $blockName ?>-block acf-block <?php echo $align_class; ?> comparison<?php echo $background ? ' comparison--bg-offwhite' : ''; ?><?php echo $more_info ? '' : ' active'; ?>">
